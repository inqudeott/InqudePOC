...
using InqudePOC.Services.Implementations;
...
namespace InqudePOC
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            filterOptions.ContentResponseEnricherList.Add(new MovieEnricher());
            ...
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1",
                    new OpenApiInfo
                    {
                        Title = "InqudePOC",
                        Version = "v1",
                        Description = "Inqude Proof Of Concept",
                        Contact = new OpenApiContact
                        {
                            Name = "Inqude",
                            Url = new Uri("https://inqude.com")
                        }
                    });
            });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "Inqude POC");
            });
