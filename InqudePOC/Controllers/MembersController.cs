...
namespace InqudePOC.Controllers
{
    ...
    public class MembersController : ControllerBase
    {
        ...
        public MembersController(ILogger<MembersController> logger, IPersonBusiness personBusiness)
        {
            _logger = logger;
        ...
        [ProducesResponseType(401)]
        [TypeFilter(typeof(HyperMediaFilter))]
        public IActionResult Post([FromBody] UserVO person)
        {
        ...
        [Authorize("Bearer")]
        [TypeFilter(typeof(HyperMediaFilter))]
        public IActionResult Put([FromBody] UserVO person)
        {
            if (person == null) return BadRequest();
